                ...
                <form id="updateRecipeForm" enctype="multipart/form-data">
                    ...
                    <div class="form-section">
                        ...
                        <div id="instructionsList">
                            <div class="input-group-item">
                                <input type=text list="ingredient-list" oninput="this.value = this.value.replace(/ {2,}/g, ' ').replace(/^ /g, '')" id="ingredient" maxlength="50" class="form-control" name="ingredients[]" value="${ing}" placeholder="Step 1: Preheat oven to 350°F" required>
                                <!-- <button type="button" class="btn-remove-item" onclick="removeItem(this)" style="visibility: hidden;">
                                    <i class="bi bi-trash"></i>
                                </button> -->
                            </div>
    ...
    <script>
        ...
        function renderRecipe(recipe) {
            ...
            recipe.ingredients.forEach((ing, index) => {
                ...
                div.innerHTML = `
                    <input type=text list="ingredient-list" oninput="this.value = this.value.replace(/ {2,}/g, ' ').replace(/^ /g, '')" id="ingredient" maxlength="50" class="form-control" name="ingredients[]" value="${ing}" placeholder="..." required>
                    ${index === 0 ? '' : `
            ...
            recipe.instructions.forEach((step, index) => {
                ...
                div.className = 'input-group-item';
                div.innerHTML = `
                    <input type="text" list="instruction-list" oninput="this.value = this.value.replace(/ {2,}/g, ' ').replace(/^ /g, '')" id="instruction" maxlength="50" class="form-control" name="instructions[]" value="${step}" placeholder="..." required>
                    ${index === 0 ? '' : `
                        <button type="button" class="btn-remove-item" onclick="removeItem(this)">
                            <i class="bi bi-trash"></i>
                        </button>
